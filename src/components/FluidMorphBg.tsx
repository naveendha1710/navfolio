...
export function FluidMorphBg({
  ...
  duration = 5,
  colors = [
    "#f1f5f9", // Alabaster (near-white / off-white)
    "#e2e8f0", // Mist Gray / Cloud Gray (light transition layer)
    "#cbd5e1", // Cool Gray / Pewter (medium transition layer)
    "#94a3b8", // Slate Gray (main mid-layer color)
    "#64748b", // Deep Slate (transition layer)
    "#334155", // Graphite / Deep Slate (darker layer)
    "#ffffff", // Snow White / Pure White (bright highlight)
  ],
  backgroundColor = "#f6f6f8", // Matches Projects section white background (#f6f6f8)
}: FluidMorphBgProps) {
  ...
  return (
    ...
    >
      {/* Morphing SVG Canvas with Floating Animation */}
      <svg
      ...
      >
        {pathsData.map((dList, index) => {
          ...
          const floatDuration = pathDuration * 1.5;
