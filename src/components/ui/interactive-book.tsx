...
export default function InteractiveBook({
    ...
    return (
        <div
            className={cn("relative flex items-center justify-start perspective-[2000px]", className)}
            style={{
                width: typeof width === 'number' ? width : '100%',
                height: typeof height === 'number' ? height + 50 : 'auto'
            }}
        >
            <motion.div
                className={cn(
            ...
            {!isOpen && (
                <motion.div
                    ...
                    className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-neutral-500 dark:text-neutral-400 text-xs font-medium tracking-widest uppercase cursor-pointer z-50 hover:text-neutral-700 dark:hover:text-neutral-200 transition-colors whitespace-nowrap"
