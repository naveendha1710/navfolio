...
// Memoized to prevent expensive SVG re-render when parent App state changes
export const LinePath = memo(function LinePath({
  className = "",
  scrollYProgress,
  strokeColor = "#b15382",
  strokeWidth = 14,
  ...
  // scroll 0 → path starts at 40% already drawn (appears 10% earlier)
  // scroll 0.95 → path fully drawn
  const drawFraction = useTransform(scrollYProgress, [0, 0.95], [0.4, 1]);
